...
<body>
   ...
   <div class="container">
      <div class="row">
         <img alt="banner" src="./img/offer.jpg" class="img-rounded" width="100%" height="200px">
      </div>
      <br/>
      <div class="row">
          ...
          <div id="newbidder" class="tab-pane fade">
              ...
              <form action="SignupHandler.jsp" method="post" name="signupform">
                  ...
                  <select name="location" class="form-control" required>
							...
							<input type="password" name="password" class="form-control" placeholder="Enter Password" required/><br/>
							<input type="password" onkeyup="checkPassword()" name="password2" class="form-control" placeholder="RenterPassword" required/>
							<span id="msg"></span>
							<br/>
							
                            <input type="submit" value="Signup" class="btn btn-lg btn-block btn-info"/>
              </form>
          </div>
